              ...
              <div v-for="product in order.products" :key="product._id">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-10 col-lg-10 col-10">
                    ...
                    <div class="a-row">
                      <span class="a-size-mini a-color-secondary">Sold by: Bottodrawer Export Sales LLC</span>
                    </div>
                    <div class="a-row">
                      <!-- Product Size -->
                      <span class="a-size-mini" style="color: #111; font-weight: 400;">Size: {{ product.productID.size}}</span>
                    </div>
                    <div class="a-row">
                      <!-- Product price -->
