          ...
          <div class="col-sm-6">
            ...
            <div class="a-section">
              ...
              <div class="a-section a-spacing-none a-spacing-top-small">
                <b>The total price is Rs. {{ getCartTotalPriceWithShipping }}</b>
              </div>
...
export default {
  ...
  mounted() {
    this.stripe = Stripe("pk_test_51JHcPDC93dxbFFIpdATjF4zObHbeYFf284UxlYc7VAVpHK86pVwXBTKHwwhGmAykuR7UK06TvvQbzvCasNhYtcMt001wjEP59J");
